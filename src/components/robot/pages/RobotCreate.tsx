...
const RobotCreate: React.FC = () => {
  ...
  const handleCreateDocumentRobot = async () => {
    if (!documentFile) { notify('error', 'Please upload a PDF, JPEG, or PNG file'); return; }
              ...
              <Box sx={{ width: '100%', maxWidth: 700 }}>
                ...
                >
                  ...
                  {documentFile ? (
                    ...
                    <>
                      <Typography variant="body1" fontWeight={500}>Click to upload a PDF, JPEG, or PNG</Typography>
